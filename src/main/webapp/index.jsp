...
<link rel="icon" href="Expenses_UI/logo.svg">
<link
...
<body>
  ...
  <symbol id="geo-fill" viewBox="0 0 16 16">
	...
	<main>
		...
		<div class="container px-4 py-5" id="featured-3">
			...
			<div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
				<div class="feature col">
					...
					<h3 class="fs-2 text-body-emphasis">Add expense</h3>
					<p>Used to add bill and living cost on one day</p>
					<a href="<%=url%>/InputProcessor?action=addPage" class="icon-link"> Go to add page<svg class="bi">
				...
				<div class="feature col">
					...
					<h3 class="fs-2 text-body-emphasis">Show Chart for Day</h3>
					<p>Show chart for Day</p>
					<a href="#" class="icon-link">Go to page <svg class="bi">
							<use xlink:href="#chevron-right" /></svg>
					</a>
				</div>
				<div class="feature col">
					...
					<h3 class="fs-2 text-body-emphasis">Show chart for Week</h3>
					<p>Show chart for Week draw by svg file</p>
					<a href="#" class="icon-link"> Go to page <svg class="bi">
							<use xlink:href="#chevron-right" /></svg>
					</a>
				</div>
			...
			<div
						...
						<div
							...
							<ul class="d-flex list-unstyled mt-auto">
								...
								<li class="d-flex align-items-center me-3"><svg
										...
										<use xlink:href="#geo-fill" /></svg> <small>Earth</small></li>
								<li class="d-flex align-items-center"><svg class="bi me-2"
										width="1em" height="1em">
										<use xlink:href="#calendar3" /></svg> <small>3d</small></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="col">
					<div
						...
						<div
							class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
							<h3 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">Much
								longer title that wraps to multiple lines</h3>
							<ul class="d-flex list-unstyled mt-auto">
								<li class="me-auto"><img src="https://github.com/twbs.png"
									alt="Bootstrap" width="32" height="32"
									class="rounded-circle border border-white"></li>
								<li class="d-flex align-items-center me-3"><svg
										class="bi me-2" width="1em" height="1em">
										<use xlink:href="#geo-fill" /></svg> <small>Pakistan</small></li>
								<li class="d-flex align-items-center"><svg class="bi me-2"
										width="1em" height="1em">
										<use xlink:href="#calendar3" /></svg> <small>4d</small></li>
							</ul>
						</div>
					</div>
				</div>
		...
		<div class="container px-4 py-5" id="icon-grid">
			...
			<div
				...
				<div class="col d-flex align-items-start">
					<svg class="bi text-body-secondary flex-shrink-0 me-3"
						width="1.75em" height="1.75em">
						<use xlink:href="#bootstrap" /></svg>
					<div>
						<h3 class="fw-bold mb-0 fs-4 text-body-emphasis">Featured
							title</h3>
						<p>Paragraph of text beneath the heading to explain the
							heading.</p>
					</div>
		...
		<div class="container px-4 py-5">
			...
			<div
				...
				<div class="col d-flex flex-column align-items-start gap-2">
					<h2 class="fw-bold text-body-emphasis">Left-aligned title
						explaining these awesome features</h2>
					<p class="text-body-secondary">Paragraph of text beneath the
                ...
                <use xlink:href="#collection" />
							...
							<h4 class="fw-semibold mb-0 text-body-emphasis">Featured
								title</h4>
							<p class="text-body-secondary">Paragraph of text beneath the
								heading to explain the heading.</p>
						</div>
	...
	<script type="text/javascript" src="index_js/indexjs.js"></script>
	<script
